...
class ExtraPayUniversalFormControl extends Control
{
	 ...
	 */
	protected $ExtraPayUniversalModel;
	...
	/**
	 * ExtraPayUniversalFormControl constructor.
	 * @param ExtraPayUniversalModel $extraPayUniversalModel
	 ...
	 */
	public function __construct(ExtraPayUniversalModel $extraPayUniversalModel, EmployeeModel $EmployeeModel, MainSubjectModel $MainSubjectModel, CommitmentModel $CommitmentModel, MonthSetModel $monthSetModel, FinancingModel $financingModel)
	{
		$this->ExtraPayUniversalModel= $extraPayUniversalModel;
	...
	public function createComponentForm()
	{
		...
		$form
			->addSelect('employee', 'Zaměstnanec', $this->EmployeeModel->getListByMainSubject($main_subject->getId(), true))->setPrompt('Vyber zaměstnance')->setHtmlAttribute('class', 'extra-pay-form-employee-select');
	...
	public function formSubmit( Form $form )
	{
		...
		if( $this->ExtraPayUniversalModel->save($entity) ) {
